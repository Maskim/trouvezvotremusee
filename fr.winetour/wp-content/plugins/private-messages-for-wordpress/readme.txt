=== Plugin Name ===
Contributors: rilwis
Donate link: http://www.deluxeblogtips.com/
...
Thank OP351.net for translation idea and thank others for helping in translation the plugin.

Icon for this plugin is design by [Matthias Kretschmann](http://matthiaskretschmann.com).

Please visit [plugin page](http://www.deluxeblogtips.com/2009/10/private-messages-for-wordpress.html) for support.
...
* Add Hungarian translations, thank Jazoja
...
* Add Italian translations, thank Enrico

= 2.1.2 =

* Update French translations, thank liryk
...
* Add French language by Cyril. Thank you. (I received 3 translations of French from Cyril, Olivier (Misterco), and MTN Concept. I'm not sure which is the best!)
